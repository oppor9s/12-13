...
<html>
	...
	<div>
		...
		<div class="header2">
			...
			<tr>
				<td><a href="${ctx }/findproduct/findByPage?pagenum=1">所有商品</a></td>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=1&id=1">巨小型</a></td>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=1&id=2">巨大型</a></td>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=1&id=3">中型</a></td>
			</tr>
		</div>
		...
		<script type="text/javascript">
			...
			<tr>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=1&id=${id}">首页</a></td>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=${prenum}&id=${id}">上一页</a></td>
				<td><a href="${ctx }/findproduct/findBytype1?pagenum=${nextnum}&id=${id}">下一页</a></td>
			</tr>
		</div>
		<div class="footer">
